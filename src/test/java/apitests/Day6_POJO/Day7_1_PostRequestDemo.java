...
public class Day7_1_PostRequestDemo {
 ...
 */
    ...
    public void PostNewSpartan(){
        ...
        Response response = given().log().all()
                ...
                .and()
                .body(jsonBody) // this is already json type
                .when()
                .post("/api/spartans");
    ...
    public void PostNewSpartan2(){
        ...
        given().log().all()
                ...
                .contentType(ContentType.JSON)
                .and()
                .body(requestMap)   // normally i should convert map to json (serialization), body make it for us
                .when()             // body does it only for post,put,patch methods
                .post("/api/spartans")
                .then().log().all()
                .statusCode(201)
                .and()
    ...
    public void PostNewSpartan3(){
        ...
        given().log().all()
                ...
                .contentType(ContentType.JSON)
                .and()
                .body(spartanEU) //serialize object to json
                .when()
                .post("/api/spartans")
                .then().log().all()
                .statusCode(201)
    ...
    public void PostNewSpartan4(){
        ...
        //get request
        int idFromPost = response.path("data.id");  //dynamiek get request
